...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lineEdit_FindRowInfo = QtWidgets.QLineEdit(Dialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Ignored, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lineEdit_FindRowInfo.sizePolicy().hasHeightForWidth())
        self.lineEdit_FindRowInfo.setSizePolicy(sizePolicy)
        self.lineEdit_FindRowInfo.setObjectName("lineEdit_FindRowInfo")
        self.verticalLayout.addWidget(self.lineEdit_FindRowInfo)
        self.pushButton_findRow = QtWidgets.QPushButton(Dialog)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Ignored, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_findRow.sizePolicy().hasHeightForWidth())
        self.pushButton_findRow.setSizePolicy(sizePolicy)
        self.pushButton_findRow.setObjectName("pushButton_findRow")
        self.verticalLayout.addWidget(self.pushButton_findRow)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton_findRow.setText(_translate("Dialog", "查找相应的行"))
